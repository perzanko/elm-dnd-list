...
var author$project$Main$initialModel = {draggingEntryId: 0, isDragging: false, list: _List_Nil, tempList: _List_Nil};
		...
		switch (msg.$) {
			case 'OnDragStartMsg':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{draggingEntryId: entry.id, isDragging: true, tempList: model.list}),
					elm$core$Platform$Cmd$none);
			case 'OnDragEndMsg':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{draggingEntryId: author$project$Main$initialModel.draggingEntryId, isDragging: author$project$Main$initialModel.isDragging, list: model.tempList, tempList: author$project$Main$initialModel.tempList}),
					elm$core$Platform$Cmd$none);
			default:
				var entry = msg.a;
				var currentEntry = A2(
					...
					A2(
						...
						function (x) {
							return _Utils_eq(x, model.draggingEntryId);
						}),
					model.list);
				var direction = function () {
					...
					if (_n3.$ === 'Just') {
						var x = _n3.a;
						return (_Utils_cmp(x.order, entry.order) < 0) ? 'DOWN' : 'UP';
					} else {
						return 'DOWN';
					}
				}();
				var _n1 = A2(
					...
					(direction === 'DOWN') ? function (x) {
						return _Utils_cmp(x.order, entry.order) < 1;
					} : function (x) {
						return _Utils_cmp(x.order, entry.order) < 0;
					},
					A2(
						elm$core$List$filter,
						function (x) {
							return !_Utils_eq(x.id, model.draggingEntryId);
						},
						model.list));
				var beforeList = _n1.a;
				var afterList = _n1.b;
				var orderedList = A2(
					elm$core$List$map,
					function (_n2) {
...
var author$project$Main$OnDragEndMsg = {$: 'OnDragEndMsg'};
var author$project$Main$OnDragOverMsg = function (a) {
	return {$: 'OnDragOverMsg', a: a};
};
var author$project$Main$OnDragStartMsg = function (a) {
	return {$: 'OnDragStartMsg', a: a};
};
...
var author$project$Main$view = function (model) {
	var list_ = model.isDragging ? model.tempList : A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				'dnd' + (model.isDragging ? ' is-dragging' : ''))
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('dnd__list')
					]),
				A2(
					elm$core$List$map,
					function (entry) {
						return A2(
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class(
									'dnd__item' + (_Utils_eq(entry.id, model.draggingEntryId) ? ' dnd__item--is-dragging' : '')),
										...
										return A2(
											...
											function (content) {
												return elm$json$Json$Decode$succeed(
													{content: content, dragging: dragging, id: id, name: name, order: order});
											},
											A2(elm$json$Json$Decode$field, 'content', elm$json$Json$Decode$string));
									},
									A2(elm$json$Json$Decode$field, 'dragging', elm$json$Json$Decode$bool));
							},
							A2(elm$json$Json$Decode$field, 'id', elm$json$Json$Decode$int));
					},
					A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string));
			},
			A2(elm$json$Json$Decode$field, 'order', elm$json$Json$Decode$int))))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.Entry":{"args":[],"type":"{ id : Basics.Int, name : String.String, content : String.String, dragging : Basics.Bool, order : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"OnDragStartMsg":["Main.Entry"],"OnDragEndMsg":[],"OnDragOverMsg":["Main.Entry"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));