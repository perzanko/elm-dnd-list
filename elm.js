...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { az: 'hidden', F: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { az: 'mozHidden', F: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { az: 'msHidden', F: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { az: 'webkitHidden', F: 'webkitvisibilitychange' }
		: { az: 'hidden', F: 'visibilitychange' };
}
...
var author$project$Main$initialModel = {l: 0, t: false, m: _List_Nil, p: _List_Nil};
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{l: entry.s, t: true, p: model.m}),
					elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{l: author$project$Main$initialModel.l, t: author$project$Main$initialModel.t, m: model.p, p: author$project$Main$initialModel.p}),
					elm$core$Platform$Cmd$none);
			default:
				var entry = msg.a;
				var currentEntry = A2(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													elm$html$Html$text(
													elm$core$String$fromInt(entry.s))
												])),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$list(
		A2(
										...
										return A2(
											...
											function (content) {
												return elm$json$Json$Decode$succeed(
													{O: content, Y: dragging, s: id, Q: name, g: order});
											},
			...
			A2(elm$json$Json$Decode$field, 'order', elm$json$Json$Decode$int))))(0)}});}(this));